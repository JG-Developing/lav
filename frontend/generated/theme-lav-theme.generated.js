...
import stylesCss from 'themes/lav-theme/styles.css?inline';
...
export const applyTheme = (target) => {
  ...
  if (!document['_vaadintheme_lav-theme_componentCss']) {
    
    document['_vaadintheme_lav-theme_componentCss'] = true;
  }
